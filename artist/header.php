		...
		<div class="container">
			<div class="head-main">
				...
				<div class="col-md-4 head-middle">
					<h1><a href="artist_home.php">Art Gallery Artists</a></h1>
				</div>
				<div class="col-md-4 head-right">
					<a href="artist_home.php" style="color:#FFFFFF"><?php echo $_SESSION['user_name']; ?></a>
				</div>
	...
	<div class="navigation">
		<span class="menu"></span> 
			<ul class="navig cl-effect-16">
				<li class="active"><a href="artist_home.php">Home</a></li>
				<li><a href="about.php">About</a></li>
				<li><a href="paintings_view.php">Art Gallery</a></li>
				<!--<li><a href="typo.html">Short Codes</a></li>-->
				
				<li><a href="exibition_details.php">Events</a></li>
