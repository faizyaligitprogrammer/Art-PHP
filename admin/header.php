		...
		<div class="container">
			<div class="head-main">
				...
				<div class="col-md-4 head-middle">
					<h1><a href="admin_home.php">Art Gallery Admin</a></h1>
				</div>
	...
	<div class="navigation">
		<span class="menu"></span> 
			<ul class="navig cl-effect-16">
				...
				<li><a href="artist_details.php">Artists</a></li>
				<!--<li><a href="typo.html">Short Codes</a></li>-->
				<li><a href="user_details.php">Users</a></li>
                <li><a href="comments.php">Comments</a></li>
                <!--<li><a href="registration.php">Purchases</a></li>
                <li><a href="registration.php">Exhibitions</a></li>-->
