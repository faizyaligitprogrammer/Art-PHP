...
include("connect.php");
$u_id=$_GET['id'];
$qry=mysqli_query($con,"select * from ag_purchase_request,ag_paintings,ag_user_details where ag_purchase_request.painting_id=ag_paintings.paintings_id and ag_purchase_request.user_details_id=ag_user_details.user_details_id and ag_purchase_request.user_details_id='$u_id'");
...
$sql=mysql_query("select * from ag_purchase_request,ag_paintings where ag_purchase_request.painting_id=ag_paintings.paintings_id and ag_purchase_request.user_details_id='$user_id'");*/
?>	
