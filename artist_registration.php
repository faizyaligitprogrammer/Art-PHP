...
/*   alert('Reached.........');
   return false;*/
	...
	if(fl_name == "" || usr_adrs == "" || ct_num == "" || ct_eml == "" || dob == "" || desc == "" || file == "" || usr_pwd == "" || re_pwd == "" || name == "" ){
		//alert('Reached.........');
		...
		<div class="container">
			...
			<div class="contact-bottom">
				...
				<div class="col-md-8 contact-right">
					<form name="artist registration" action="artist_registration_process.php" method="post" enctype="multipart/form-data">	
					...
					<div class="col-md-6 c-left">
                         ...
                         Date Of Birth:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                         &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                         <input type="date" name="dob" placeholder="Date of Birth" id="txtDob" required><br><br>
                         Specialities:
                         <textarea placeholder="Specialities" name="specialities" id="txtDesc" required></textarea>
                         Profile Picture:
                        ...
                        Confirm Password:
						<input  type="password" width="100%" placeholder="Password" name="password" id="txtrePwd" required>
